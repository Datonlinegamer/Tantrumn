...
#include "TanTramnLocalMPCamera.h"
...
ATanTramnLocalMPCamera::ATanTramnLocalMPCamera(const FObjectInitializer& ObjectInitializer)
...
void ATanTramnLocalMPCamera::BeginPlay()
{
	Super::BeginPlay();
...
void ATanTramnLocalMPCamera::Tick(float DeltaTime)
{
